# ¡Hola! Soy Hernando Stiven Cortés 👋
...
- 💻 **Actualmente:** Desarrollador Web Frontend (mantenimiento y desarrollo de aplicaciones institucionales).
- 🎓 **Educación:** Estudiante activo de **Ingeniería de Software**
- 📱 **Especialización:** Diplomado en **Desarrollo de Aplicaciones Móviles** (280h - Universidad Nacional de Colombia / Atenea).
- 🎯 **Enfoque:** Arquitectura limpia, reutilización de componentes y optimización de rendimiento UI/UX.
